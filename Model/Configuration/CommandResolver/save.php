...
class save extends \LWmvc\Model\CommandResolver
{
    ...
    {
        try {
            $dataValueObject = new \LWddd\ValueObject($this->command->getDataByKey('postArray'));
            ...
            $parameter['notification'] = $dataValueObject->getValueByKey("notification");
            $parameter['approval_admin'] = $dataValueObject->getValueByKey("approval_admin");
            $content = false;
